...
% ---- Tableau Server ------------------------------------------------------------
\begin{secbox}[twbGray]{Tableau Server / Cloud}
\end{secbox}

\begin{tipbox}
There is currently \textbf{no Tableau Server/Cloud integration}: the
\texttt{tbs\_*()} stubs were removed in 0.5.0.9000 because they never made a
network request. Server support is planned as a real feature.
...
\begin{tcolorbox}[
  ...
  \scriptsize
  \textbf{twbparser} \textcolor{twbMid}{0.5.1} \quad
  MIT License \quad
