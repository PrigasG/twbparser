...
### Title: Custom SQL (Metadata API) for a published workbook/datasource
### Aliases: tbs_custom_sql_graphql

### ** Examples

## Not run: 
##D tbs_custom_sql_graphql(
##D   content_id = "abc-123",
##D   base_url   = Sys.getenv("TABLEAU_BASE_URL"),
##D   site       = Sys.getenv("TABLEAU_SITE"),
##D   token      = "<token>"
##D )
## End(Not run)
...
## Not run: 
##D tbs_publish_info(content_id = "abc-123", base_url = Sys.getenv("TABLEAU_BASE_URL"),
##D                  site = Sys.getenv("TABLEAU_SITE"), token = "<token>")
## End(Not run)
## Not run: 
##D tbs_custom_sql_graphql(content_id = "abc-123",
##D   base_url = Sys.getenv("TABLEAU_BASE_URL"),
##D   site = Sys.getenv("TABLEAU_SITE"),
##D   token = "<token>")
## End(Not run)
